...
<template>
  <div :dir="dir" class="v-select" :class="stateClasses">
    ...
    <div :id="`vs${uid}__combobox`" ref="toggle" @mousedown="toggleDropdown($event)" class="vs__dropdown-toggle"
    ...
    <transition :name="transition">
      <ul ref="dropdownMenu" v-if="dropdownOpen" :id="`vs${uid}__listbox`" class="vs__dropdown-menu" role="listbox"
          @mousedown.prevent="onMousedown" @mouseup="onMouseUp" v-append-to-body>
